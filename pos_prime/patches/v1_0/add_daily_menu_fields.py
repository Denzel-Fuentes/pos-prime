...
def execute():
	...
	# exist, so re-running it here only adds the new
	# pos_prime_available_items field on POS Opening Entry without touching
	# the ones the earlier patches already created.
